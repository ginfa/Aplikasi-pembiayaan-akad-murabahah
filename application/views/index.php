     ...
     <!-- Navigation -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index.html" style="color:white;"><i class="fa fa-dashboard fa-fw nav_icon"></i>Hello, <?php echo $this->session->userdata('nama')?></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo base_url()?>assets/frontend/widgets.html"><i class="fa fa-flask nav_icon"></i>Widgets</a>
                        </li>
                         <li>
                        ...
                        <li>
                            <a href="<?php echo base_url();?>Utama/logout" style="color:white;"><i class="fa fa-sitemap fa-fw nav_icon"></i>Logout</a>
                            <!-- /.nav-second-level -->
                        </li>
                    </ul>
                </div>
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="<?php echo base_url()?>assets/frontend/css/clndr.css" type="text/css" />
			<script src="<?php echo base_url()?>assets/frontend/js/underscore-min.js" type="text/javascript"></script>
			<script src="<?php echo base_url()?>assets/frontend/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="<?php echo base_url()?>assets/frontend/js/clndr.js" type="text/javascript"></script>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="<?php echo base_url()?>assets/frontend/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="<?php echo base_url()?>assets/frontend/js/jquery.vmap.js"></script>
<script src="<?php echo base_url()?>assets/frontend/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="<?php echo base_url()?>assets/frontend/js/jquery.vmap.world.js" type="text/javascript"></script>
