  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <center><h3 class="box-title">Data Penghasilan</h3></center>
            ...
            <form class="form-horizontal">
              ...
              padding: 5px; overflow: auto; width: 966px; height: 300px; background-color: rgb(255, 255, 255);">
                ...
                <tr>
                  ...
                  <th>No rekening</th>
                  <th>Penghasilan Suami</th>
                  <th>Penghasilan Istri</th>
                  <th>Penghasilan Lainnya</th>
                  <th>Biaya Rmh Tangga</th>
                  <th>Kebutuhan Anak</th>
                  <th>Pengeluaran Pribadi</th>
                ...
                <tbody>
                  <?php
	                 $id_penghasilan = 1;
	                  foreach ($tampil_penghasilan->result() as $value) {
	                 ?>
                <tr>
                  <td><?php echo $value->id_penghasilans; ?></td>
                  <td><?php echo $value->no_rekening; ?></td>
                  <td><?php echo number_format($value->penghasilan_suami,2,',','.'); ?></td>
                  <td><?php echo number_format($value->penghasilan_istri,2,',','.'); ?></td>
                  <td><?php echo number_format($value->penghasilan_lainnya,2,',','.'); ?></td>
                  <td><?php echo number_format($value->biaya_rmh_tangga,2,',','.'); ?></td>
                  <td><?php echo number_format($value->biaya_kb_anak,2,',','.'); ?></td>
                  <td><?php echo number_format($value->pengeluaran_pribadi,2,',','.'); ?></td>
                  <td><?php echo number_format($value->pembayaran_hutang,2,',','.'); ?></td>
                  <td><?php echo number_format($value->pengeluaran_lainnya,2,',','.'); ?></td>
                  <th>
                    <a class="btn btn-info" href="<?php echo base_url() ?>Teller/edit_penghasilan/<?php echo $value->id_penghasilan ?>">Edit</a>
                    <a class="btn btn-danger" href="<?php echo base_url() ?>Teller/hapuspenghasilan/<?php echo $value->id_penghasilan ?>">Hapus</a>
                  </th>
                </tr>
                <?php $id_penghasilan++;  } ?>
                </tfoot>
