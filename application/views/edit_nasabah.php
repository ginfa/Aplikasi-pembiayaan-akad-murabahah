<?php
	...
	foreach ($tampilnasabahbyid->result() as $value) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <center><h3 class="box-title">Mengubah Data Nasabah</h3></center>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url()?>Teller/ubahdatanasabah" method="post" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPassword3"
                     placeholder="Nama" name="nama_edit" required="true" value="<?php echo $value->nama ?>">
                  </div>
                </div>
								<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPassword3"
                     placeholder="Tempat lahir" name="tempat_lahiredit" required="true" value="<?php echo $value->tempat_lahir ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="input-group date" >
                  <div class="col-sm-10">
                    ...
                    name="tempat_tanggal_lahiredit" placeholder="" value="<?php echo $value->tempat_tanggal_lahir ?>">
                  </div>
                </div>
              </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPassword3"
                    name="pekerjaan_edit" placeholder="Pekerjaan" value="<?php echo $value->pekerjaan ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPassword3"
                     required="true" name="nomor_identitasedit" placeholder="No identitas" value="<?php echo $value->nomor_identitas ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPassword3"
                     required="true" name="saldo_edit" placeholder="Saldo" value="<?php echo $value->saldo ?>">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
