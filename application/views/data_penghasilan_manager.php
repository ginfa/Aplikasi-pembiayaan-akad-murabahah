  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <center><h3 class="box-title">Data Penghasilan Nasabah</h3></center>
            ...
            <form class="form-horizontal">
              ...
              padding: 5px; overflow: auto; width: 966px; height: 300px; background-color: rgb(255, 255, 255);">
                ...
                <tbody>
                  <?php
	                 $id_nasabah = 1;
	                  foreach ($tampilnasabahpenghasilan->result() as $value) {
	                 ?>
                <tr>
                  <td><?php echo $value->no_rekening; ?></td>
                  <td><?php echo $value->penghasilan_suami; ?></td>
                  <td><?php echo $value->penghasilan_istri; ?></td>
                  <td><?php echo $value->penghasilan_lainnya; ?></td>
                  <td><?php echo $value->biaya_rmh_tangga; ?></td>
                  <td><?php echo $value->biaya_kb_anak; ?></td>
                  <td><?php echo $value->pengeluaran_pribadi; ?></td>
                  <td><?php echo $value->pembayaran_hutang; ?></td>
                  <td><?php echo $value->pengeluaran_lainnya; ?></td>
                </tr>
                <?php $id_nasabah++;  } ?>
                </tfoot>
              </table>
