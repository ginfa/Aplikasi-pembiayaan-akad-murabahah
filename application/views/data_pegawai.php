      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url()?>Manager/tampil_pembiayaan_m"><i class="glyphicon glyphicon-record"></i> Akad </a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <tbody>
                  <?php
	                 $id_pegawai = 1;
	                  foreach ($tampil_pegawai->result() as $value) {
	                 ?>
                <tr>
                  ...
                  <td><?php echo $value->status; ?></td>
                    <th>
                        <a class="btn btn-info" href="<?php echo base_url() ?>Manager/edit_pegawai/<?php echo $value->id_pegawai ?>">Edit</a>
                    </th>
                </tr>
                <?php $id_pegawai++;  } ?>
                </tfoot>
