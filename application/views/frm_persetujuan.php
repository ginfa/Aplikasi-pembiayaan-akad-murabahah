      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url()?>Manager/tampil_pembiayaan_transaksi"><i class="glyphicon glyphicon-record"></i> Data Transaksi</a></li>
      ...
      <div class="box">
        <div class="col-md-13">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Pengambilan keputusan akad</h3>
            </div>
            <form class="form-horizontal">
              ...
              padding: 5px; overflow: auto; width: 966px; height: 300px;background-color: rgb(255, 255, 255);">
                ...
                <tr>
                  ...
                  <th>
                    <a class="btn btn-info" href="<?php echo base_url() ?>Manager/persetujuanakad/<?php echo $value->id_pembiayaan ?>">Setuju</a>
                    <a class="btn btn-danger" href="<?php echo base_url()?>Manager/penolakanakad/<?php echo $value->id_pembiayaan ?>">Tolak</a>
                  </th>
                </tr>
                <?php $id_pembiayaan++;  } ?>
                </tfoot>
