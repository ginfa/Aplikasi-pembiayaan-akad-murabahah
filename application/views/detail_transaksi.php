  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <center><h3 class="box-title">Detail transaksi</h3></center>
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <tbody>
                  <?php
                   $id_jurnal = 1;
                    foreach ($tampil_detail_transaksi->result() as $value) {
                   ?>
                <tr>
                  <td><?php echo $value->idc_pembayaran; ?></td>
                  <td><?php echo $value->id_pembiayaan; ?></td>
