...
foreach ($tampilpegawaibyid->result() as $value) {
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="box-header with-border">
                            <center><h3 class="box-title">Edit Data Pegawai</h3></center>
                    ...
                    <div class="box">
                        <form class="form-horizontal" action="<?php echo base_url()?>Manager/ubahdatapegawai" method="post" >
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Username</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="id_ahliwarisz"
                                               required="true" name="username_edit" value="<?php echo $value->username ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="no_rekening"
                                                required="true" name="password_edit" value="<?php echo $value->password ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="alamat_edit"
                                               id="inputEmail3" placeholder="Nama" required="true" value="<?php echo $value->alamat ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Alamat</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3"
                                               name="no_tlp_edit" placeholder="Alamat" required="true" value="<?php echo $value->no_tlp ?>">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
