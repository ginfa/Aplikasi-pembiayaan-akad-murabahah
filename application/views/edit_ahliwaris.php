<?php
	...
	foreach ($tampilawbyid->result() as $value) {
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          ...
          <center><h3 class="box-title">Edit Data Ahli Waris</h3></center>
      ...
      <div class="box">
        <form class="form-horizontal" action="<?php echo base_url()?>Teller/ubahdataahliwaris" method="post" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    readonly="true" required="true" name="id_ahliwarisz" value="<?php echo $value->id_ahliwarisz ?>" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama_edit"
                     id="inputEmail3" placeholder="Nama" required="true" value="<?php echo $value->nama ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3"
                     name="alamat_edit" placeholder="Alamat" required="true" value="<?php echo $value->alamat ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    name="no_tlp_edit" placeholder="No telepon" required="true" value="<?php echo $value->no_tlp ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Pekerjaan</label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="pekerjaan_edit" id="status" value="PNS" checked>PNS
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="pekerjaan_edit" id="status" value="Pegawai Swasta">Pegawai Swasta
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="pekerjaan_edit" id="status" value="Lain-lain">Lain-lain
                    </label>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3"
                     name="hubungan_edit" placeholder="Hubungan" required="true" value="<?php echo $value->hubungan ?>">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
