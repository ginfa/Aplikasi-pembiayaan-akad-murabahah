  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <center><h3 class="box-title">Data Ahli waris</h3></center>
      ...
      <div class="box">
        <div class="col-md-13">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Data Ahli Waris</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <tbody>
                  <?php
	                 $id_ahliwaris = 1;
	                  foreach ($tampil_ahliwaris->result() as $value) {
	                 ?>
                <tr>
                  <td><?php echo $value->id_ahliwarisz; ?></td>
                  ...
                  <th>
                    <a class="btn btn-info" href="<?php echo base_url() ?>Teller/edit_ahliwaris/<?php echo $value->id_ahliwaris ?>">Edit</a>
                    <a class="btn btn-danger" href="<?php echo base_url() ?>Teller/hapusahliwaris/<?php echo $value->id_ahliwaris ?>">Hapus</a>
                  </th>
                </tr>
                <?php $id_ahliwaris++;  } ?>
                </tfoot>
