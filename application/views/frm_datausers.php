<?php
 ...
 $sql = "select right(id_datausers, 3) as id_datauserr from tb_datauser order by id_datausers DESC";
...
<?php
 ...
 ?>
    ...
    function required()
    {
        ...
        var no_tlp_kantor = document.getElementById("no_tlp_kantor");
        var no_tlp_usaha = document.getElementById("no_tlp_usaha");
        var jumlah_tanggungan = document.getElementById("jumlah_tanggungan");

        var validasiAngka = /^[0-9]+$/;
        if(no_tlp.value.match(validasiAngka)){

        } else{
            alert("no tlp harus dalam bentuk angka");
            return false;
        }

         if(no_tlp_kantor.value.match(validasiAngka)){

        } else{
            alert("no tlp kantor harus dalam bentuk angka");
            return false;
        }

        if(no_tlp_usaha.value.match(validasiAngka)){

        } else{
            alert("no tlp usaha harus dalam bentuk angka");
            return false;
        }

        if(jumlah_tanggungan.value.match(validasiAngka)){

        } else{
            alert("jumlah tanggungan harus dalam bentuk angka");
            return false;
        }
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <center><h3 class="box-title">Pencatatan Data User</h3></center>
      ...
      <!-- Default box -->
      <div class="box">
        <form class="form-horizontal" action="<?php echo base_url()?>Teller/addUser" method="post" id="frm_datausers" onsubmit="return required();">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    readonly="true" required="true" name="id_datausers" value="<?= $number; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Status</label>
                    ...
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status" id="status" value="Janda/Duda">Janda/Duda
                    </label>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    placeholder="Pendidikan terakhir" name="pendidikan_terakhir" required="true" >
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    placeholder="Jumlah Tanggungan" required="true">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    placeholder="Lama Berusaha" name="lama_usaha" required="true">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Status Usaha</label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_usaha" id="status_usaha" value="Milik Sendiri" >Milik Sendiri
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_usaha" id="status_usaha" value="Join">Join
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_usaha" id="status_usaha" value="Lain-lain">Lain-lain
                    </label>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Status Rumah</label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_rumah" id="status_rumah" value="Milik Sendiri" >Milik Sendiri
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_rumah" id="status_rumah" value="Join">Join
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_rumah" id="status_rumah" value="Lain-lain">Lain-lain
                    </label>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Status Kios</label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_kios" id="status_rumah" value="Milik Sendiri" >Milik Sendiri
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_kios" id="status_rumah" value="Join">Join
                    </label>
                    <label class="radio-inline" style="margin-left:20px;">
                        <input type="radio" name="status_kios" id="status_rumah" value="Lain-lain">Lain-lain
                    </label>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-8">
                      <textarea class="form-control1" rows="3" name="alamat"
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="no_tlp" name="no_tlp"
                     placeholder="No telepon" required="true"><span id="pesan"></span>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Alamat Kantor</label>
                  <div class="col-sm-8">
                      <textarea class="form-control1" rows="3" name="alamat_kantor"
                      required="true"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="no_tlp_kantor"
                     name="no_tlp_kantor" placeholder="No telepon kantor" required="true">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Alamat Usaha</label>
                  <div class="col-sm-8">
                      <textarea class="form-control1" rows="3" name="alamat_usaha"
                      required="true"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    name="no_tlp_usaha" placeholder="No telepon kantor" required="true">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
              <button type="submit" name="button"  class="btn btn-info pull-right">Save</button>
              </div>
              <!-- /.box-footer -->
            </form>
        <!-- /.box-footer-->
