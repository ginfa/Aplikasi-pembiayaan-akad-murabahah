            ...
            <form class="form-horizontal">
              ...
              padding: 5px; overflow: auto; width: 966px; height: 300px;background-color: rgb(255, 255, 255);">
                ...
                <tbody>
                  <?php
	                 $id_datauser = 1;
	                  foreach ($tampil_datauser->result() as $value) {
	                 ?>
                <tr>
                  <td><?php echo $value->id_datausers; ?></td>
                  ...
                  <td><?php echo $value->status_kios; ?></td>
                  ...
                  <td><?php echo $value->no_tlp_usaha; ?></td>
                  <th>
                    <a class="btn btn-info" href="<?php echo base_url() ?>Teller/edit_user/<?php echo $value->id_datauser ?>">Edit</a>
                    <a class="btn btn-danger" href="<?php echo base_url() ?>Teller/hapususer/<?php echo $value->id_datauser ?>">Hapus</a>
                  </th>
                </tr>
                <?php $id_datauser++;  } ?>
                </tfoot>
