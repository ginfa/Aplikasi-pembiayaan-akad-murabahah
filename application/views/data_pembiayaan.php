  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <center><h3 class="box-title">Data Pembiayaan</h3></center>
      ...
      <div class="box">
        <div class="col-md-13">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Data Pembiayaan</h3>
            </div>
              ...
              padding: 5px; overflow: auto; width: 966px; height: 300px; background-color: rgb(255, 255, 255);">
                ...
                <tr>
                  ...
                  <td><?php echo $value->jaminan; ?></td>
                    <td><?php echo $value->nomor_jaminan; ?></td>
                  <td><?php echo $value->status_pembiayaan; ?></td>
                  <td><?php if($value->status_pembiayaan == 'setuju') { ?>
                          <a class="btn btn-info" href="<?php echo base_url() ?>Teller/cetak_akad/<?php echo $value->id_pembiayaans ?>">Cetak Akad</a>
                      <?php } ?> </td>
                </tr>
                <?php $id_pembiayaan++;  } ?>
                </tfoot>
