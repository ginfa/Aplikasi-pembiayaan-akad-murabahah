      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url()?>Pegawai/tampil_pegawai"><i class="glyphicon glyphicon-record"></i> Data Pegawai </a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url()?>Manager/data_pembiayaan"><i class="glyphicon glyphicon-record"></i> Data Transaksi</a></li>
          </ul>
        </li>
        <li>
          ...
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                <?php
               $id_audit = 1;
                foreach ($tampil_audithitung->result() as $value) {
               ?></span>
               <?php echo $query->hitung() ?>
